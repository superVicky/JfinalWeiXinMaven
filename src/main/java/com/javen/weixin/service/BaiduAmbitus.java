...
import com.javen.weixin.entity.BaiduAmbitusEntity;
		 ...
		 if (list!=null) {
			 ...
			 for (BaiduAmbitusEntity baiduAmbitusEntity : list) {
				...
				// String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
				 ...
				 article.setPicUrl("https://mmbiz.qlogo.cn/mmbiz/NbxiacLlcia9evB6d9y6XQdOO3rPcEvdiaXEE6PxOhEVx5zV1ZPkMwiaVWR7Inlj8SU9S3R3Tw54wRdlCbH81V4Xfw/0?wx_fmt=jpeg");
